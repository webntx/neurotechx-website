...
**Money Handling** The money always flow through the organization's bank account and not through individuals bank account. The money is currently centralized in NeuroTechX HQ and redistributed to chapters and initiatives. The Finance Director (Ferdinand) is the one handling these transaction. We do have many different processes in place to facilitate exchange of money both between NTX and our partners, and also NTX and its chapters.
