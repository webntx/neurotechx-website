...
sourceUrl: 'https://github.com/NeuroTechX/NTX-dockit/blob/master/getting-started.rst'
updatedAt: '2026-06-21'
---
# Getting Started

If you are interested in creating a chapter in your city, please fill out the following [form](http://goo.gl/forms/HFqTewsKTn) to let us know.
...
<ul>
  <li><label><input type="checkbox" disabled /> Access to your city Google Drive folder to store your meetup pictures and information</label></li>
  <li><label><input type="checkbox" disabled /> A City Mastersheet to help you keep track of speakers, venues, etc</label></li>
  <li><label><input type="checkbox" disabled /> A Meetup page to be used to manage your community</label></li>
  <li><label><input type="checkbox" disabled /> Your cities Twitter account</label></li>
  <li><label><input type="checkbox" disabled /> A private admin channel on slack</label></li>
</ul>
...
1.  Go to [Meetup.com](http://www.meetup.com) and select Start a Meetup Group.
