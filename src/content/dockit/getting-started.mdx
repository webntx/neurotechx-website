...
<form action="">
<ul>
    <li><input type="checkbox" value="" /> Access to your city Google Drive folder to store your meetup pictures and information</li>
    <li><input type="checkbox" value="" /> A City Mastersheet to help you keep track of speakers, venues, etc</li>
    <li><input type="checkbox" value="" /> A Meetup page to be used to manage your community</li>
    <li><input type="checkbox" value="" /> Your cities Twitter account</li>
    <li><input type="checkbox" value="" /> A private admin channel on slack</li>
</ul>
</form>
