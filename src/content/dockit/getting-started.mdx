...
<form action="">
<ul>
    <ol><input type="checkbox" value="" /> Access to your city Google Drive folder to store your meetup pictures and information</ol>
    <ol><input type="checkbox" value="" /> A City Mastersheet to help you keep track of speakers, venues, etc</ol>
    <ol><input type="checkbox" value="" /> A Meetup page to be used to manage your community</ol>
    <ol><input type="checkbox" value="" /> Your cities Twitter account</ol>
    <ol><input type="checkbox" value="" /> A private admin channel on slack</ol>
</ul>
</form>
